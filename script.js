...
if (myCountry == 'elsewhere') {
    ...
    document.body.innerHTML += '<hr><small><i><p>' +
        ...
        listCountries +
        '.<p>Those are all the countries included in this version of this page, but not all the countries on Amenta; you\'re from one of the many others. See <a href="'+countriesDataSource+'">the spreadsheet</a> for a more complete list.</p></i></small>'
}
